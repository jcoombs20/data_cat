function initPage() {
  ...
  d3.select("#ediSource")
    ...
    .html('<option>Released</option><option>Staged</option>');
...
*/
        ...
        function addExtras() {
          ...
          tmpTD.forEach(function(cell,i) {
            ...
            tmpStr.methods = filtDoi[tmpJ].methods.replace(/'/g, "&#39;").replace(/"/g,"&#34;");
            ...
            d3.select(cell).html('<a href="' + filtDoi[tmpJ].doi + '" target="_blank" title="Open in EDI">' + tmpText + '</a>'
              ...
              + '<span><i class="fa fa-info-circle" data-toggle="tooltip" data-container="#resultsContainer" data-placement="auto" data-html="true" title="<p><b><u>Methods</u></b></p><p>' + tmpStr.methods + '</p>"></i></span>'
